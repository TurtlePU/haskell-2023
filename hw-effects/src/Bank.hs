...
-- ^ @MonadBank@ laws:
-- [Law #1 сохранение кол-ва аккаунтов (добавление аккаунта и его удаление сохраняет кол-во аккаунтов, нет исключений)] 
-- [Law #2 сохранение сохранение балансов (добавление и вычитание одинакового ткол-ва средств с одного аккаунта не изменяет его изначльное значение, нет исключений)]
-- [Law #3 сохранение в трансфере (передача 100 между двумя аккаунтами в обе стороны сохраняет изначальные балансы, нет исключений)]
--
